// JUSRC Website Content Data - Modify this file to update website content

export const timelineEvents = [
  {
    month: "Feb",
    events: [
      { title: "Handover & Formation", link: "/about#working-body" },
      { title: "Working Body Formation", link: "/about#working-body" }
    ]
  },
  {
    month: "Mar",
    events: [
      { title: "Contact Directory", link: "/mentor-directory" }
    ]
  },
  {
    month: "Apr",
...
export const overviewItems = [
  {
    id: "research-quiz",
    title: "Research Quiz",
    description: "Engaging intra- and inter-collegiate quizzes that build awareness and enthusiasm for research."
  },
  {
    id: "research-coordination", 
    title: "Research Coordination",
    description: "Streamlining UG research by sharing opportunities, FAQs, contacts, and guidance through our portal and WhatsApp group. Acting as a communication liaison between Administration, UGRMC, and IEC and Students"
  },
  {
    id: "biomedical-innovation",
    title: "Biomedical Innovation", 
    description: "Encouraging lateral thinking through initiatives like InCubate and collaborative problem-solving."
  },
  {
    id: "workshops",
    title: "Workshops",
    description: "Hands-on learning opportunities across various Departments for JIPMERites and Beyond"
  },
  {
    id: "sessions",
    title: "Sessions",
    description: "Regular interactive sessions on literature search, systematic reviews, research workflow, and USMLE-related research skills."
  },
  {
    id: "talks",
    title: "Talks", 
    description: "Expert-led discussions that expose students to advanced concepts, grant processes, and pathways in research."
  },
  {
    id: "medtech-hackathon",
    title: "MedTech Hackathon",
    description: "A flagship event to foster intersectoral collaboration"
  }
];
